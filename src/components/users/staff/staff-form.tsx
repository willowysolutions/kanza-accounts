...
export function StaffForm({ roles, branches ,defaultBranchId, onSuccess, initialData, isEdit }: StaffFormProps) {
      ...
      <Form {...form}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <FormField
            ...
            name="branch"
            render={({ field }) => {
              const branchName = branches.find(b => b.id === field.value)?.name || "";
              return (
                <FormItem>
